...
class Tuyo extends StatefulWidget {

  @override
  _TuyoState createState() => _TuyoState();
}

class _TuyoState extends State<Tuyo> {
        ...
        child: Stack(
            children:[
              ...
              Positioned(
                top: -10,
                right: 0,
                child: _buildActionButtons('tuyo'),
              ),
            ]
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          _buildImageContainer('images/tuyo.jpg'),
