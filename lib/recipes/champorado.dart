...
class Champorado extends StatefulWidget {

  @override
  _ChamporadoState createState() => _ChamporadoState();
}

class _ChamporadoState extends State<Champorado> {
        ...
        child: Stack(
            children:[
              ...
              Positioned(
                top: -10,
                right: 0,
                child: _buildActionButtons('champorado'),
              ),
            ]
        ),
      ),
  ...
  Widget _buildInstructionsContainer(){
    ...
    List<String> instructionsList = [
      ...
      '6. Serve hot with a swirl of condensed milk or evaporated milk on top.',
  ...
  Widget _buildSourceContainer(){
    ...
    Text link = Text(
      'https://panlasangpinoy.com/filipino-food-tsampurado-champorado-champurado-chocolate-rice-porridge-recipe/',
      style: kBodyTextStyle,
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          _buildImageContainer('images/champorado.png'),
